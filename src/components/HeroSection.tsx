                  ...
                  {featuredProducts.map(product => <CarouselItem key={product.id}>
                      <div className="flex flex-col items-center text-center text-white p-2 space-y-3">
                        <div className="relative group">
                          <img src={product.imageUrl} alt={product.name} className="w-60 h-40 sm:w-64 sm:h-44 object-cover rounded-xl mb-3 shadow-xl hover-lift transition-all duration-300 group-hover:scale-105" onError={e => {
